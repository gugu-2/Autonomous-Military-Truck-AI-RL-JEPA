...
class JEPAPredictor(nn.Module):
    ...
    def forward(self, context_tokens: torch.Tensor, action_context: Optional[torch.Tensor] = None) -> torch.Tensor:
        """
    ...
    def predict_single_step(self, s_t: torch.Tensor, k: int, action_context: Optional[torch.Tensor] = None) -> torch.Tensor:
