...
class GlobalRoutePlanner:
    ...
    def calculate_route(self, start_pos: Tuple[float, float], goal_pos: Tuple[float, float]) -> List[Dict[str, Any]]:
        """
        ...
        mock_route = [
            ...
            {"x": (start_pos[0]+goal_pos[0])/2, "y": (start_pos[1]+goal_pos[1])/2, "lane_id": 102},
